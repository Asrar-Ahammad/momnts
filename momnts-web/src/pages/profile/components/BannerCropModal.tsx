...
const BannerCropModal = ({ image, open, onOpenChange, onCropComplete, isUploading }: BannerCropModalProps) => {
      ...
      <DialogContent className="sm:max-w-[480px] w-[95vw] p-0 overflow-hidden bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 rounded-[32px] shadow-2xl">
        <div className="flex flex-col max-h-[90vh]">
          <DialogHeader className="p-6 pb-4">
            ...
            <p className="text-neutral-500 text-xs mt-1">Position your image for the banner profile.</p>
          </DialogHeader>
