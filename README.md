...
*   **`Photo`**: Holds metadata for individual uploads. Stores the original image, display-optimized images, and generated thumbnails URLs inside S3/R2 storage, along with processing status flags.
...
*   **Role Privileges**:
    *   `ORGANIZER` (Creator): Full authority to update/delete events, invite users, remove photos, and set upload limits.
...
*   **Styling:** Tailwind CSS + Phospher Icons
